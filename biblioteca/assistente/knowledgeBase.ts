...
export const ENTRIES: KBEntry[] = [
  ...
  },
  {
    ...
    responses: [
      'Na página inicial você vê os números do projeto: tecnologias usadas (Next.js, Vitest, Playwright), quantidade de testes e status do build. Quer que eu te leve até lá?',
      'A seção de estatísticas mostra a engenharia por trás do DVAi$: framework, testes automatizados, E2E e deploy. É o que sustenta a qualidade da plataforma.',
      'Os números ficam na home: tecnologias, testes e operação do projeto. Mostra que a plataforma é construída com engenharia sólida. Posso te levar até essa seção.',
    ],
  ...
  },
  {
    ...
    keywords: [
      { term: 'alertas inteligentes', weight: 6 },
      { term: 'alertas', weight: 4 },
      { term: 'alerta de risco', weight: 5 },
      { term: 'aviso', weight: 2 },
      { term: 'notificação', weight: 3 },
      { term: 'me avisar', weight: 3 },
      { term: 'alerta de disciplina', weight: 5 },
    ],
    responses: [
  ...
  },
  {
    ...
    keywords: [
      { term: 'personalização', weight: 4 },
      { term: 'personalizada', weight: 4 },
      { term: 'se adapta', weight: 5 },
      { term: 'aprende comigo', weight: 5 },
      { term: 'aprende com você', weight: 5 },
      { term: 'ia aprende', weight: 4 },
      { term: 'personalizar', weight: 3 },
      { term: 'meu perfil', weight: 3 },
      { term: 'meu nível', weight: 3 },
    ],
    responses: [
  ...
  },
  {
    ...
    keywords: [
      { term: 'por que cadastrar', weight: 6 },
      { term: 'vale a pena', weight: 4 },
      { term: 'por que usar', weight: 4 },
      { term: 'qual a vantagem', weight: 4 },
      { term: 'pra que serve', weight: 3 },
      { term: 'por que assinar', weight: 5 },
      { term: 'benefícios', weight: 3 },
      { term: 'vantagens', weight: 3 },
      { term: 'me convence', weight: 3 },
      { term: 'por que', weight: 1 },
    ],
    responses: [
